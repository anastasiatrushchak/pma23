from vasylyshyn.Vasylyshyn_Dmytro.abstraction.Shape import Circle, Rectangle, Square
from vasylyshyn.Vasylyshyn_Dmytro.abstraction.colabs import Colabs
from vasylyshyn.Vasylyshyn_Dmytro.abstraction.color import RedColor, BlueColor, GreenColor

red_circle = Colabs(Circle(RedColor(), 5), RedColor())
print(red_circle.apply_color())

blue_rectangle = Colabs(Rectangle(BlueColor(), 4, 6), BlueColor())
print(blue_rectangle.apply_color())
