...
print("Array list:", my_list)
my_list.add(37)
print("Після додавання елементу 37:", my_list)
my_list.insert(12, 4)
print("Після вставлення елементу 4 в індексі 12:", my_list)

my_list.remove(10)
print("Після видалення елементу 10:", my_list)

print("Довжина: ", len(my_list))
my_list.clear()
